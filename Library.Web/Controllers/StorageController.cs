    ...
    public class StorageController : Controller
    {
        ...
        public async Task<ActionResult> Add(StorageViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await HelperMethods.LogHelper.AddEntityWithLog(entity, storageService.AddStorageAsync, logService);
        ...
        public async Task<ActionResult> Edit(StorageViewModel model)
        {
            ...
            {
                var entity = model.Adapt<Storage>();
                await HelperMethods.LogHelper.UpdateEntityWithLog(entity, storageService.UpdateStorageAsync, logService);
        ...
        public async Task<ActionResult> Delete(StorageViewModel item)
        {
            ...
            TempData["Success"] = Warnings.SuccessfullyDeletedGeneric<Storage>();
