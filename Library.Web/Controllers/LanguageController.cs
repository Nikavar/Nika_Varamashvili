    ...
    public class LanguageController : Controller
    {
        ...
        public async Task<ActionResult> Add(LanguageViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await HelperMethods.LogHelper.AddEntityWithLog(entity, languageService.AddLanguageAsync, logService);
        ...
        public async Task<ActionResult> Edit(LanguageViewModel model)
        {
            ...
            {
                var entity = model.Adapt<Language>();
                await HelperMethods.LogHelper.UpdateEntityWithLog(entity, languageService.UpdateLanguageAsync, logService);
